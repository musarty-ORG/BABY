...
<body>
    ...
    <script type="text/babel">
        try {
          ...
          // Note: This uses eval() for preview purposes only. The code being executed
          // is AI-generated code that the user requested, not arbitrary user input.
          // This is necessary to provide live preview functionality in the browser.
          ...
          <div className="space-y-6">
            ...
            {showPredictivePanel && pipelineResult.codeFiles && (
              <PredictiveInsightsPanel
                codeFiles={pipelineResult.codeFiles}
                projectType="nextjs"
                userId={pipelineResult.requestId}
