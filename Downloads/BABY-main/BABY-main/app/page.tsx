...
export default function CodeHomieHome() {
  const [selectedModel, setSelectedModel] = useState<'scout' | 'maverick'>(
    'scout'
  )
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setMessages((prev) => [
        ...prev,
        { role: 'assistant', content: `AI response for: ${input}` },
      ])
      setIsLoading(false)
    }, 1000)
  }
              ...
              <div className="space-y-6">
                <div className="inline-flex items-center gap-2 bg-purple-500/20 border border-purple-500/40 rounded-full px-4 py-2 text-sm">
                  ...
                  <span className="text-purple-300">
                    Powered by GPT-4O | Llama DeepSeek | Scout
                  </span>
                </div>
                  ...
                  {messages.length === 0 && (
                    <div className="text-center py-12">
                      ...
                      <p className="text-purple-500/70 text-sm mb-6">
                        Your legendary coding companion is online. Ask anything
                        about programming, get code examples, or discuss tech.
                      </p>
