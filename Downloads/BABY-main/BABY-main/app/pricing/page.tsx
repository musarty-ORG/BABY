        ...
        <div className="max-w-7xl mx-auto px-4 py-16">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Choose the perfect plan for your coding journey with our
            ...
            >
              <div className="p-8">
                ...
                <div className="mb-6">
                  ...
                  <p className="text-gray-400 text-sm">
                    For heavy users and complex projects
                  </p>
                </div>
                <div className="space-y-4 mb-8">
                  <div className="flex items-center gap-3">
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-purple-500/30">
                    ...
                    <th className="text-center py-4 text-purple-400">
                      Basic Homie
                    </th>
                    <th className="text-center py-4 text-green-400">
                      Builder Homie
                    </th>
                    <th className="text-center py-4 text-blue-400">
                      Architect Homie
                    </th>
                  </tr>
                </thead>
              ...
              <div>
                ...
                <ul className="space-y-3">
                  <li className="flex items-start gap-3">
                    ...
                    <span className="text-gray-300">
                      1 message = up to 1,000 tokens generated for your request
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="mt-1 min-w-5">
                    ...
                    <span className="text-gray-300">
                      Token usage is rounded up: ceil(tokens / 1000) = messages
                      deducted
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    ...
                    <span className="text-gray-300">
                      Follow-up questions from Code Homie don't cost tokens
                    </span>
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="space-y-3">
                  <li className="flex items-start gap-3">
                    ...
                    <span className="text-gray-300">
                      Monthly bucket resets on renewal date
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="mt-1 min-w-5">
                    ...
                    <span className="text-gray-300">
                      Top-ups never expire and are used before monthly bucket
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="mt-1 min-w-5">
                    ...
                    <span className="text-gray-300">
                      If bucket is empty, you'll be prompted to top-up or
                      upgrade
                    </span>
                  </li>
                </ul>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                ...
                <p className="text-gray-300">
                  A token-message represents up to 1,000 tokens generated in
                  response to your request. Tokens are the basic units that AI
                  models process, roughly equivalent to 4 characters or 0.75
                  words.
                </p>
              </div>
              <div>
                ...
                <p className="text-gray-300">
                  No, your monthly message allocation resets when your
                  subscription renews. However, any top-up messages you purchase
                  never expire and will be used before your monthly allocation.
                </p>
              </div>
              <div>
                <h3 className="text-lg font-semibold text-green-400 mb-3">
                ...
                <p className="text-gray-300">
                  ...
                  upgrading, you'll get immediate access to the new plan's
                  benefits. When downgrading, the change will take effect on
              ...
              <div>
                ...
                <p className="text-gray-300">
                  Follow-up questions that Code Homie asks you to clarify your
                  request don't count against your token usage. Only the tokens
                  generated in response to your requests are counted.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 py-8">
          <div className="text-center">
            <p className="text-purple-500/70 text-sm">
              Code Homie v2.1 | Powered by Llama 4 Scout & Maverick | Secure
              Neural Network
            </p>
            <p className="text-purple-500/50 text-xs mt-2">
              ...
              <Link
                href="/admin"
                className="text-purple-500/50 hover:text-purple-500/70"
              >
                Danger
              </Link>
            </p>
