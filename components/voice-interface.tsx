...
export default function VoiceInterface({ onVoiceCommand, onSpeechResponse, className = "" }: VoiceInterfaceProps) {
  ...
  return (
    <div className={`bg-gray-900/50 border border-purple-500/30 rounded-lg p-4 ${className}`}>
      {/* Header */}
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-2">
          <Mic className="w-5 h-5 text-purple-400" />
          <h3 className="text-lg font-semibold text-purple-400">Voice Interface</h3>
        </div>
        <button
      ...
      {showSettings && (
        <div className="mb-4 p-3 bg-gray-800/50 border border-purple-500/20 rounded-lg">
          <h4 className="text-sm font-semibold text-purple-400 mb-3">Voice Settings</h4>

          <div className="space-y-3">
            <div>
              <label className="block text-xs text-purple-300/70 mb-2">Select Voice</label>
              <select
                value={selectedVoice}
      ...
      <div className="space-y-2">
        {isRecording && (
          <div className="bg-red-900/20 border border-red-500/30 rounded-lg p-3">
            <div className="flex items-center gap-2 text-red-400">
              ...
              <span className="text-sm font-semibold">Recording... Speak your command</span>
            </div>
            <p className="text-xs text-red-300/70 mt-1">
              Say things like: "Make the header bigger", "Add a search button", "Change color to blue"
            </p>
          </div>
        )}
        ...
        {lastTranscript && (
          <div className="bg-green-900/20 border border-green-500/30 rounded-lg p-3">
            <div className="text-green-400 text-sm font-semibold mb-1">Last Command:</div>
      ...
      <div className="mt-4 pt-3 border-t border-purple-500/30">
        <h4 className="text-xs font-semibold text-purple-400 mb-2">Quick Commands:</h4>
